  ...
  return (
    ...
    >
      ...
      >
        <Box
          ...
          sx={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 12% 8%, rgba(124,58,237,0.2) 0%, rgba(5,5,5,0) 36%), radial-gradient(circle at 90% 18%, rgba(56,189,248,0.1) 0%, rgba(5,5,5,0) 34%)",
            pointerEvents: "none",
          }}
        />
                        ...
                        <Stack spacing={0.6} sx={{ pl: 2.4, pr: 0.2, pt: 0.8 }}>
                          {group.sections.map((section) => {
                            const isSectionActive =
                              isPageActive && currentSection === section.key;
      ...
      >
        ...
        <DialogContent>
          <Typography
            sx={{ color: "rgba(228,228,231,0.82)", fontSize: "0.95rem" }}
          >
            Você possui modificações não salvas nesta edição. Deseja sair mesmo
            assim?
          </Typography>
        </DialogContent>
