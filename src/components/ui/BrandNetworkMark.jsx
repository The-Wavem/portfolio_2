...
export default function BrandNetworkMark({
  ...
  const resolvedTextColor =
    textColor || (surface === "light" ? "#111111" : "#F5F5F5");
        ...
        {nodes.map((node, index) => (
          <MotionCircle
            ...
            transition={{
              ...
              cy: {
                duration: motionConfig.waveDuration + index * 0.1,
                repeat: Infinity,
                ease: "easeInOut",
                delay: index * 0.14,
              },
