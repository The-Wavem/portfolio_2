    ...
    return (
        ...
        >
            ...
            <Container maxWidth="md">
                ...
                >
                    <Box>
                        <Stack direction="row" flexWrap="wrap" gap={1.5} justifyContent="center" sx={{ mb: 3 }}>
                        ...
                        >
                            {hero?.titleStart || 'Engenharia Sólida e'} <span style={{ color: '#7C3AED', WebkitTextFillColor: '#7C3AED' }}>{hero?.titleHighlight || 'Design para Problemas Reais.'}</span>
                        </MotionTypography>
                        ...
                        >
                            {hero?.description || 'Equilibramos estética, clareza de fluxo e arquitetura de ponta para gerar resultados contínuos.'}
                        </Typography>
                        ...
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} justifyContent="center" width={{ xs: '100%', sm: 'auto' }}>
                            <Button
                                ...
                                onClick={() => trackAction({ page: 'home', section: 'hero', action: 'click_primary_cta', label: hero?.primaryCta?.label || 'Iniciar Projeto' })}
                                variant="contained"
                                size="large"
                                sx={{
                                    px: 4,
                            ...
                            <Button
                                ...
                                onClick={() => trackAction({ page: 'home', section: 'hero', action: 'click_secondary_cta', label: hero?.secondaryCta?.label || 'Ver Portfolio' })}
                                variant="outlined"
                                size="large"
                                sx={{
                                    px: 4,
