...
export const homeProcessContent = {
    titlePrefix: 'Do cafézinho ao',
    titleHighlight: 'código.',
    description: 'Você acompanha o projeto de ponta a ponta, com checkpoints claros, decisões registradas e previsibilidade de entrega sem ruído.',
    steps: [
        {
            id: 1,
